...
GraphicObject::GraphicObject()
{
	...
	this->box.cfp.x = this->pos.x + objLength;		// uwzględnić rotację?
...
void GraphicObject::rotateBoundingBox(float angle)
{
	...
	//float fpAngle = this->box.currentRotation + fpArc + 90 - angle;		// kąt obrotu dla prawej strony (arcsin() dodatni)
